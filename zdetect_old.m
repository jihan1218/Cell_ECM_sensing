    ...
    elseif b == 50 % '2' to save box data and move to next cells
        ...
        while(breaker2)
            ...
            elseif b2 == 49 % '1' to draw polygons
                breaker3 = 1;
                count3 = 0;
                disp(' Now draw a polygon: to add a point press 1');
                while(breaker3)
         ...
         for j = 0 : flt(i)-1
             ...
             if count2 <= tframe
                   ...
                   if count2 == 1
                    ...
                    '25C_collagen_iron/sample_%02d_%02ddeg/xyt_cell3/cell_%03d'],...
                    numsample,angle,l);
                ...
                for k = 1:step:ly
                    ...
                    [ztemp,im] = diagdetect(imgcs,sobel1,sobel2,thresh);
                    zpos(index1,1) = ztemp;
                end

                if nnz(zpos)>1
                    zp = round(mean(nonzeros(zpos)))-1;
                    zdepth(count2,1) = zp;
...
filename = sprintf(['/home/kimji/Project/Cell_mechanics/cell_ECM_sensitivity/'...
                    '25C_collagen_iron/sample_%02d_%02ddeg/xyt_cell3/xy_corner.mat'],...
                        numsample,angle);
%{               
filename = sprintf(['/Users/jihan/OneDrive/working/sample_%02d_%02ddeg/'...
    'xyt_cell/xy_corner.mat'],...
