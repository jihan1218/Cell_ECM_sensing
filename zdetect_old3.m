...
numsample = 1;                  %sample number
angle = 40;                     %sample angle
totaltime = 60;                 %total xyzt time
framerate = frate;
lt = 0;
                   ...
                   if count2 == 1
                        if station == 1
                            nfoldname = sprintf(['/Users/Sungroup/Documents/Justin/'...
                                'sample_%02d_%02ddeg/xyt_cell%d/cell_%03d'],...
                            numsample,angle,foldn,l);
                       
                        elseif station == 2
                            nfoldname = sprintf(['/home/kimji/Project/Cell_mechanics/cell_ECM_sensitivity/'...
                            '25C_collagen_iron/sample_%02d_%02ddeg/xyt_cell%d/cell_%03d'],...
                            numsample,angle,foldn,l);
                        elseif station == 3 
...
if station == 1
    ...
    filename = sprintf(['/Users/Sungroup/Documents/Justin/'...
        'sample_%02d_%02ddeg/xyt_cell%d/xy_corner.mat'],...
        numsample,angle,foldn);
elseif station == 2 
               
    filename = sprintf(['/home/kimji/Project/Cell_mechanics/cell_ECM_sensitivity/'...
                        '25C_collagen_iron/sample_%02d_%02ddeg/xyt_cell%d/xy_corner.mat'],...
                            numsample,angle,foldn);
elseif station == 3

    filename = sprintf(['/Users/jihan/OneDrive/working/sample_%02d_%02ddeg/'...
        'xyt_cell%d/xy_corner.mat'],...
        numsample,angle,foldn); 
end
